...
for( firstMovieGenres of movies[0].genres){
  console.log(firstMovieGenres);
}

// 19. Log all the genres of the second movie one by one

for( secondMovieGenres of movies[1].genres){
  console.log(secondMovieGenres);
}
