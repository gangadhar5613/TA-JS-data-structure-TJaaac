...
for(peopleDes of  got.houses[1].people){
  console.log(`I am ${peopleDes.name} and my bio is ${peopleDes.description}`);
}
...
for(peopleStarks of got.houses[0].people){
  console.log(`I am ${peopleStarks.name} and my bio ${peopleStarks.description}`)
}
